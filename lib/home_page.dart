...
void main() async {
  ...
  List catalogo = await getCatalogo();
  print(catalogo);

  runApp(new MaterialApp(
    home: new Center(
      child: new UsuariosListWidget(catalogo),
    ),
  ));
}

Future<List> getCatalogo() async {
  String apiUrl = 'https://api.mlab.com/api/1/databases/testerendafixa/catalogo/my-coll?apiKey=mpy9XeFEAADjptaUHNYVjFnji0py4sI8';
...
class UsuariosListWidget extends StatelessWidget {
  ...
  final List _catalogo;

  UsuariosListWidget(this._catalogo);
    ...
    return new Flexible(
        child: new ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final Map currency = _catalogo[index];
